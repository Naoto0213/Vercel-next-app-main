      ...
      <div className="lg:hidden">
        ...
        {isMenuOpen && (
          <div className="absolute top-0 left-0 w-full">
            <div className="p-5 bg-gray-700 border rounded border-gray-900 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <div>
                  <button
                    ...
                    title="Close Menu"
                    className="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-900 focus:bg-gray-700 focus:outline-none focus:shadow-outline"
